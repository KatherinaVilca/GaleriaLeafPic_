                ...
                case UCrop.REQUEST_CROP:
                    ...
                    if (imageUri != null && imageUri.getScheme().equals("file")) {
                        try {
                            ...
                            // ORIGINAL: StorageHelper.copyFile(getApplicationContext(), new File(imageUri.getPath()), new File(this.album.getPath()))
                           // Album albu= edicion.getAlbum();
                            if (StorageHelper.copyFile(getApplicationContext(), new File(imageUri.getPath()), new File(albu.getPath()))) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_edit:
                ...
                Intent editionIntent = new Intent(getApplicationContext(), EditActivity.class);
                editionIntent.putExtra("EXTRA_ALBUM_PATH",album.getPath());
                editionIntent.putExtra("EXTRA_IMAGE_PATH",getCurrentMedia().getPath());
